...
test.describe("user sees exercise on exercises.html after refresh", function(){
  var driver;
  this.timeout(10000);
  ...
  test.it("user can see same exercise on exercises.html before and after refresh", function() {
    driver.get("http://localhost:8080/exercises.html");
